...
import { ChevronDown, Coffee, TrendingUp, Home, MapPin } from 'lucide-react'
...
export default function HeaderNav() {
  ...
  const menuItems = [
    ...
    { name: '대형카페', href: '/largecafe', hasDropdown: true, dropdownItems: largeCafeMenu },
    { name: '카페 순위', href: '/rankings' },
